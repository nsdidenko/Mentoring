...
class FizzBuzzTests: XCTestCase {
    ...
    func test_fizzBuzz_returnsFizzForAllNumbersMultipliesOfThree() {
        let fizzBuzzed = fizzBuzz([1, 3, 4, 9])
        
        XCTAssertEqual(fizzBuzzed, ["1", "Fizz", "4", "Fizz"])
    }
    
    func test_fizzBuzz_returnsBuzzForAllNumbersMultipliesOfFive() {
        let fizzBuzzed = fizzBuzz([2, 5, 7, 10])
        
        XCTAssertEqual(fizzBuzzed, ["2", "Buzz", "7", "Buzz"])
    }
    
    func test_fizzBuzz_returnsFizzBuzzForAllNumbersMultipliesOfFifteen() {
